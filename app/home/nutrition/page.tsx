...
export default function page() {
    ...
    return (
      ...
      >
        ...
        <h1
          ...
          className="text-[2rem] sm:text-[3rem] md:text-[3rem] italic mb-[15px] sm:mb-[10px] font-[cursive]">
          YOUR WEEK PLAN
        </h1>
        {/* First week row */}
              ...
              <div key={index} onClick={() => setDay(index + 1)} className="cursor-pointer">
                {
                  today == day.date ?
                    ...
                    :
                    <div
                      key={index} className="bg-gradient-to-l from-[#091171] to-[#333] p-5 w-auto h-[100px] md:w-[150px] md:h-auto text-center rounded-[30px] text-[2rem] shadow-md transition-transform duration-200 ease-in-out relative z-[1] hover:-translate-y-[5px]">
                      <p className="my-[5px] text-[20px] italic text-[#958f8f] transition-all duration-300">
                        {day.day}
                      </p>
                      <p className="my-[5px] text-[0.9rem] text-[#0c0c0c] font-bold transition-all duration-300">
  ...
  return (
    <>
      {!selectedRecipe && (
        <div className="max-w-7xl w-[90%] bg-[#071465] p-10 rounded-2xl backdrop-blur-sm shadow-lg flex justify-center flex-col gap-8 z-10 animate-[fadeIn_1s_ease-out]">
